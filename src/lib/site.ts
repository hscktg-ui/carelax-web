...
export const COMPANY = {
  ...
  headline:
    "헬스케어 대중화를 앞당기는\n안마의자 브랜드, 케어렉스입니다.",
  intro:
    "파나소닉 한국 총판에서 10여 년을 보낸 노재학 대표는 2006년 이노코프를 설립했습니다. 후지의료기·다이와를 국내에 공급하며 쌓은 노하우로 2015년 케어렉스를 출범했습니다. 일본은 안마의자 보급률이 가구의 25%에 달하지만, 국내에서는 아직 비용 부담으로 망설이는 가정이 많습니다. 케어렉스는 그 격차를 줄이기 위해 품질과 가격의 군형을 선택합니다.",
  chapters: [
    {
