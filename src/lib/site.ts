  ...
  chapters: [
    {
      ...
      body: "불필요한 기능을 줄이고 튼튼하고 합리적인 소재를 선택해, 동급 품질을 더 쉽게 접근할 수 있게 만듭니다. 고품질 헬스케어 기기를 합리적인 가격에 공급해 대중화를 앞당기는 것이 케어렉스의 출발점입니다.",
    },
    {
      title: "짧은 회복을 위해, 미세한 케어에 집중합니다.",
      body: "마사지볼이 최대 12cm까지 나와 손가락 지압처럼 시원한 안마감을 만듭니다. 팔은 전방향 지압, 발은 종아리·발가락·뒤꿈치까지 다루는 토털 풋케어로 짧은 시간의 회복을 설계합니다.",
    },
    {
      title: "고객의 몸과 공간을 함께 이해합니다.",
      body: "큰 부피와 무거운 무게는 안마의자의 고질적인 단점이었습니다. 케어렉스는 기존 대비 부피를 30% 이상 축소한 CLX157·S20을 주력으로, 집안과 주간보호센터 같은 시설 공간에서도 쉽게 쓰이는 회복을 제안합니다. 61개월 무상 A/S로 품질 신뢰도 증명합니다.",
    },
  ],
} as const;
...
export const TRUST = [
  ...
  {
    title: "공식 블로그",
    body: "주간보호센터·시설 현장과 브랜드 소식은 네이버 블로그에서 확인합니다.",
  },
] as const;
